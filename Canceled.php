...
<!DOCTYPE html>
<html><head>
    <title>Asmodeus - Disputed</title>
            <meta http-equiv="Content-type" content="text/html; charset=UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="stylesheet" type="text/css" href="Bohemia%20-%20Orders-Canceled_files/flexboxgrid.min.css">
        <link rel="stylesheet" type="text/css" href="Bohemia%20-%20Orders-Canceled_files/fontawesome-all.min.css">
        <link rel="icon" type="image/jpeg" href="img/pentagram.jpg">
        <link rel="stylesheet" type="text/css" href="Bohemia%20-%20Orders-Canceled_files/style.css"><link rel="stylesheet" type="text/css" href="Bohemia%20-%20Orders-Canceled_files/main.css"><link rel="stylesheet" type="text/css" href="Bohemia%20-%20Orders-Canceled_files/responsive.css">        <link rel="stylesheet" type="text/css" href="Bohemia%20-%20Orders-Canceled_files/sprite.css">
...
<li class="right shopping-cart-link">
    ...
    <li><a href="usercp.php?action=orders" class="active"><div class="sprite sprite--clipboardlist" style="top: 2px; margin-right: 15px;"></div>Orders</a></li>
    <li>
            ...
            <div class="col-md-9 sidebar-content-right">
                <form action="" method="GET" style="display: flex; min-height: 55px;">
                    <div style="flex-grow: 1;">
                        ...
                        <input type="hidden" name="do" value="canceled">
                ...
                <div class="container product-listing nopadding">
                    <ul class="tabs">
                            ...
                            <li><a href="canceled.php" class="tab-active">Canceled&nbsp; <span class="badge badge-secondary">0</span></a></li>

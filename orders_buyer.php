...
<html><head>
    <title>Asmodeus - Orders</title>
        ...
        <link rel="stylesheet" type="text/css" href="Orders_files/flexboxgrid.min.css">
        <link rel="icon" type="image/jpeg" href="img/pentagram.jpg">
        <link rel="stylesheet" type="text/css" href="Orders_files/fontawesome-all.min.css">
        <link rel="stylesheet" type="text/css" href="Orders_files/style.css"><link rel="stylesheet" type="text/css" href="Orders_files/main.css"><link rel="stylesheet" type="text/css" href="Orders_files/responsive.css">        <link rel="stylesheet" type="text/css" href="Orders_files/sprite.css">
...
<div class="navigation">
        <div class="wrapper">
            <ul>
                <li class="nav-logo"><a href="http://wbxnudwhsfpta4ljzwm7mhkzph4ntpsvidubwr2gptfqyg4fohyrv7ad.onion/bohemia/homepage.php"><img src="Listings_files/logo_small.png" style="height: 100%;"></a></li>
			...
			<li class="dropdown-link dropdown-large">
                ...
                <!--<li class="dropdown-link dropdown-large " style="margin-left:260px; position:absolute; width:210px; margin-top:-15px;">
                            ...
                            <div class="dropdown-content right-dropdown">
                            <a href="products.php">View/Edit/Del All Products</a>
                            <a href="add-category.php">Add Category</a>
                            <a href="add-product.php">Add Products</a>
                            <a href="category.php">View/Edit/Del List Of Categories</a>
    ...
    <li><a href="http://wbxnudwhsfpta4ljzwm7mhkzph4ntpsvidubwr2gptfqyg4fohyrv7ad.onion/bohemia/usercp.php?action=orders" class="active"><div class="sprite sprite--clipboardlist" style="top: 2px; margin-right: 15px;"></div>Orders</a></li>
    <li>
	<a href="http://wbxnudwhsfpta4ljzwm7mhkzph4ntpsvidubwr2gptfqyg4fohyrv7ad.onion/bohemia/usercp.php?action=wallet"><div class="sprite sprite--wallet" style="top: 2px; margin-right: 15px;"></div>Wallet</a>	
    </li>
    <li><a href="http://wbxnudwhsfpta4ljzwm7mhkzph4ntpsvidubwr2gptfqyg4fohyrv7ad.onion/bohemia/usercp.php?action=exchange"><div class="sprite sprite--affiliate" style="top: 2px; margin-right: 15px;"></div>Exchange </a></li>
    <li><a href="http://wbxnudwhsfpta4ljzwm7mhkzph4ntpsvidubwr2gptfqyg4fohyrv7ad.onion/bohemia/usercp.php?action=affiliate"><div class="sprite sprite--money" style="top: 2px; margin-right: 15px;"></div>Affiliate Programme</a></li>
    <li><a href="http://wbxnudwhsfpta4ljzwm7mhkzph4ntpsvidubwr2gptfqyg4fohyrv7ad.onion/bohemia/usercp.php?action=editprofile"><div class="sprite sprite--card" style="top: 2px; margin-right: 15px;"></div>Edit Profile</a></li>
    <li><a href="http://wbxnudwhsfpta4ljzwm7mhkzph4ntpsvidubwr2gptfqyg4fohyrv7ad.onion/bohemia/usercp.php?action=changepin"><div class="sprite sprite--qr" style="top: 2px; margin-right: 15px;"></div>Change PIN</a></li>
    <li><a href="http://wbxnudwhsfpta4ljzwm7mhkzph4ntpsvidubwr2gptfqyg4fohyrv7ad.onion/bohemia/usercp.php?action=changepassword"><div class="sprite sprite--lock" style="top: 2px; margin-right: 15px;"></div>Change Password</a></li>
    <li><a href="http://wbxnudwhsfpta4ljzwm7mhkzph4ntpsvidubwr2gptfqyg4fohyrv7ad.onion/bohemia/usercp.php?action=settings"><div class="sprite sprite--cog" style="top: 2px; margin-right: 15px"></div>Settings</a></li>
</ul>
            </div>
            <div class="col-md-9 sidebar-content-right">
                ...
                <div class="container product-listing nopadding">
                    ...
                    <li><a href="http://wbxnudwhsfpta4ljzwm7mhkzph4ntpsvidubwr2gptfqyg4fohyrv7ad.onion/bohemia/usercp.php?action=orders" class="tab-active">Processing&nbsp; <span class="badge badge-secondary">0</span></a></li>

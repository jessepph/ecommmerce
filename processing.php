...
<html>
<head>
    <title>Asmodeus - Processing</title>
...
// SQL query to count total quantity in the cart for the current user
$sql = "SELECT IFNULL(SUM(quantity), 0) AS total_quantity FROM cart WHERE username = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("s", $safe_username);
$stmt->execute();
$result = $stmt->get_result();
$row = $result->fetch_assoc();
$totalItemCount = $row['total_quantity'];

// Set badge classes based on counts
$alert_badge_class = $unread_count > 0 ? 'badge-danger' : 'badge-grey';
$shopping_cart_badge_class = $totalItemCount > 0 ? 'badge-danger' : 'badge-grey';
...
<li class="right shopping-cart-link">
    <a href="cart.php">
        ...
        &nbsp;<span class="<?php echo $shopping_cart_badge_class; ?>" style="padding: 0.3em 0.4em; font-size: 75%; font-weight: 700; color: white; border-radius: 0.25rem;">
...
<li class="right shopping-cart-link">
    <a href="messages.php">
        ...
        &nbsp;<span class="<?php echo $alert_badge_class; ?>" style="padding: 0.3em 0.4em; font-size: 75%; font-weight: 700; color: white; border-radius: 0.25rem;">
            <?php echo $unread_count > 0 ? $unread_count : '0'; ?>
        </span>
    </a>
</li>
    ...
    <li><a href="usercp.php?action=orders" class=""><div class="sprite sprite--clipboardlist" style="top: 2px; margin-right: 15px;"></div>Orders</a></li>
    <li>
	<a href="usercp.php?action=wallet"><div class="sprite sprite--wallet" style="top: 2px; margin-right: 15px;"></div>Wallet</a>	
    </li>
    <li><a href="usercp.php?action=exchange"><div class="sprite sprite--affiliate" style="top: 2px; margin-right: 15px;"></div>Exchange </a></li>
    <li><a href="usercp.php?action=affiliate"><div class="sprite sprite--money" style="top: 2px; margin-right: 15px;"></div>Affiliate Programme</a></li>
    <li><a href="usercp.php?action=editprofile"><div class="sprite sprite--card" style="top: 2px; margin-right: 15px;"></div>Edit Profile</a></li>
    <li><a href="usercp.php?action=changepin"><div class="sprite sprite--qr" style="top: 2px; margin-right: 15px;"></div>Change PIN</a></li>
    <li><a href="usercp.php?action=changepassword"><div class="sprite sprite--lock" style="top: 2px; margin-right: 15px;"></div>Change Password</a></li>
    <li><a href="usercp.php?action=settings"><div class="sprite sprite--cog" style="top: 2px; margin-right: 15px"></div>Settings</a></li>
</ul>
            </div>
            <div class="col-md-9 sidebar-content-right">
                ...
                <div class="container product-listing nopadding">
                    ...
                    <li><a href="processing.php" class="tab-active">Processing&nbsp; <span class="badge badge-secondary">0</span></a></li>
                            <li><a href="dispatched.php">Dispatched&nbsp; <span class="badge badge-danger">1</span></a></li>
                            <li><a href="completed.php" class="">Completed&nbsp; <span class="badge badge-danger">1</span></a></li>

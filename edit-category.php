...
<li class="right shopping-cart-link">
    ...
    <div class="row">
        <div class="col-md-12">
            <?php
            // This function will fetch data from a given table by ID
function getByID($table, $id) {
    global $conn; // Ensure you have a global database connection variable $conn
    ...
    return $result;
        ...
        include("functions.php"); // Include the file containing getByID() function

if (isset($_GET['id'])) {
    // Sanitize the input
    $id = intval($_GET['id']);
    $category = getByID("categories", $id); // Using the getByID function
    ...
    if (mysqli_num_rows($category) > 0) {
        ...
        <div class="card">
            <div class="card-header bg-primary">
                <h3 class="text-white" style="text-align:center;">Edit Category</h3>
            </div>
            <div class="card-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
                            <input type="hidden" name="category_id" value="<?= htmlspecialchars($data['id']) ?>">
                            <label for="">Name</label>
                            <input type="text" name="name" value="<?= htmlspecialchars($data['name']) ?>" placeholder="Enter Category Name" class="form-control" required>
                        </div>

                        <div class="col-md-6">
                            <label for="">Slug</label>
                            <input type="text" name="slug" value="<?= htmlspecialchars($data['slug']) ?>" placeholder="Enter slug" class="form-control" required>
                        </div>

                        <div class="col-md-12">
                            <label for="">Description</label>
                            <textarea rows="3" name="description" placeholder="Enter description" class="form-control" required><?= htmlspecialchars($data['description']) ?></textarea>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <?php if ($data['image']): ?>
                                <img src="uploads/<?= htmlspecialchars($data['image']) ?>" style="width:10%;" height="50" alt="">
                            <?php endif; ?>
                        </div>

                        <div class="col-md-12">
                            <label for="">Meta Title</label>
                            <input type="text" name="meta_title" value="<?= htmlspecialchars($data['meta_title']) ?>" placeholder="Enter meta title" class="form-control">
                        </div>

                        <div class="col-md-12">
                            <label for="">Meta Description</label>
                            <textarea rows="3" name="meta_description" placeholder="Enter meta description" class="form-control"><?= htmlspecialchars($data['meta_description']) ?></textarea>
                        </div>

                        <div class="col-md-12">
                            <label for="">Meta Keywords</label>
                            <textarea rows="3" name="meta_keywords" placeholder="Enter meta keywords" class="form-control"><?= htmlspecialchars($data['meta_keywords']) ?></textarea>
                        </div>

                        <div class="col-md-6">
                            <label for="">Status</label>
                            <input type="checkbox" <?= $data['status'] ? "checked" : "" ?> name="status" value="1">
                        </div>

                        <div class="col-md-6">
                            <label for="">Popular</label>
                            <input type="checkbox" <?= $data['popular'] ? "checked" : "" ?> name="popular" value="1">
                        </div>
    ...
    echo "<div class='alert alert-warning'>Id missing from URL</div>";
}
            ?>
        </div>
    </div>

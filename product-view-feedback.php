...
<html>
    ...
    <title>Product View</title>
        ...
        <link rel="stylesheet" href="product-view-stylesheet.css">
    ...
    <script>
// JavaScript code to scroll to the top of the page upon refresh
...
<body style="background-color:white; height:120%;">
...
<font style="font-size:115%;" color="white"></font><center><font style="font-size:115%;" color="white">All (CategorName) products from (VendorName)<br></font></center></h6></td></tr>
...
if (!empty($productName)) {
    ...
    if (!empty($rowProductDescription)) {
        ...
        echo '
        <div class="menu-content" id="description" style="width:100%;margin-top:0px0px;">

...
$sql = "SELECT IFNULL(order_count, 0) AS order_count FROM cart WHERE username = ? LIMIT 1";
...
<li class="right shopping-cart-link">
    ...
    <li><a href="http://localhost/orders.php?action=orders" class="active"><div class="sprite sprite--clipboardlist" style="top: 2px; margin-right: 15px;"></div>Orders</a></li>
    <li>
            ...
            <div class="col-md-9 sidebar-content-right">
                <form action="" method="GET" style="display: flex; min-height: 55px;">
                    <div style="flex-grow: 1;">
                        ...
                        <input type="text" name="query" style="width:100%;" class="form-control" placeholder="Search orders by username, order reference, or listing name...">
                    </div>
                ...
                <div class="container product-listing nopadding">
                    <ul class="tabs">
                        <li><a href="processing.php" class="">Processing&nbsp; <span class="badge badge-secondary">0</span></a></li>
                            <li><a href="dispatched.php" class="tab-active">Dispatched&nbsp; <span class="badge badge-danger">1</span></a></li>
                            <li><a href="completed.php" class="">Completed&nbsp; <span class="badge badge-danger">2</span></a></li>
                    ...
                    <form action="" method="post">
                        ...
                        <table class="cart-table" cellspacing="0" cellpadding="0">
                            ...
                            <tbody>
                                                                        <tr>
                                                                                        <td><img src="dispatched_files/image.jpeg" style="width: 60px;"></td>
                                            <td>
                                                <b>1x <a href="http://3k74gkozsjayfqysmalx7qw7lwubf4jhlhk4ihij4t2cwc6s2rahm7qd.onion/listing.php?pid=4da40910-1d09-11ee-beb5-d05099fcf7bb">10x Needlepoint LSD Gel Tabs 200ug</a>&nbsp; <span class="smalltext">In LSD</span></b><br>
                                                <b><a href="http://3k74gkozsjayfqysmalx7qw7lwubf4jhlhk4ihij4t2cwc6s2rahm7qd.onion/profile.php?id=thegoldenroad">thegoldenroad</a></b>
                                                <span class="smalltext shadow-text"> | <span class="user-percent" style="color: #29b474;">100%</span> Positive Feedback&nbsp; |&nbsp; <div class="sprite sprite--shopping-cart" style="float: none;display: inline-block; margin-left:5px;;"></div>&nbsp; 37</span>
                                            </td>
                                            <td><div class="sprite sprite--bitcoin" style="top:2px;"></div>&nbsp;                                        
                                        </td>

                                            <td>$60 <br><span class="smalltext shadow-text">Total cost</span></td>
                                            <td>
                                                <span class="badge badge-pill badge-warning">Shipped</span>                                            </td>
                                            <td>
                                                                                                        <div class="dropdown-link">
                                                            <button class="dropbtn btn btn-blue">Options&nbsp; <div class="sprite sprite--caret" style="float: right; top: 1px;"></div></button>
                                                            <div class="dropdown-content">
                                                                <a href="http://3k74gkozsjayfqysmalx7qw7lwubf4jhlhk4ihij4t2cwc6s2rahm7qd.onion/usercp.php?action=orders&amp;ref=OMETCVZ202307286A6E">View Order</a>
                                                                                                                                <a href="http://3k74gkozsjayfqysmalx7qw7lwubf4jhlhk4ihij4t2cwc6s2rahm7qd.onion/usercp.php?action=orders&amp;ref=OMETCVZ202307286A6E&amp;do=dispute">Open Dispute</a>                                                                

                                                                <a href="http://3k74gkozsjayfqysmalx7qw7lwubf4jhlhk4ihij4t2cwc6s2rahm7qd.onion/usercp.php?action=orders&amp;ref=OMETCVZ202307286A6E&amp;do=finalize">Finalize Order</a>
                                                            </div>
                                                        </div>
                                                                                            </td>
                                        </tr>

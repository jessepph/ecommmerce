...
">
  ...
  ">
    ...
    margin-right: 40px;
    ">
      <h3 style="text-align:center; font-size:25px;">News</h3><br><br><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum porttitor maximus nibh, congue suscipit odio. Duis et lectus euismod, ullamcorper nisl pharetra, blandit quam. 
    ...
    padding-bottom: 30px;
    ">
      <h5 style="font-size:25px;">Search</h5>
    </div>
  ...
  <div id="row-2" style="width: 100%; display: flex; flex-direction: row; justify-content: center; margin-top: 40px;">
    ...
    <div class="column-1" style="display: flex; flex-direction: column;">
      ...
      margin-bottom: 40px;
      ">
        <h3 style="text-align:center; font-size:25px;">Catagories
          <br>
          <br>
          <div class="card-body" style="font-size: 18px; text-align:center; padding-left:15px;">
...
<li></li>
  ...
  <li></li>
  <li><b>➤<a href="listing_category?id=233" class="nav-link"> Category 16 <span class="badge badge-secondary float-right">221</span></a></b></li><li>    
  </li></ul></div>
      </div>
        </h3>
